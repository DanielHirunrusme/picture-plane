...
},{"./lib/init-modules.js":2}],"modules/body":[function(require,module,exports){
function initializeBarbaModules(){for(var a=$(".barba-container").find("[data-module-init]"),e=0;e<a.length;e++)for(var t,i=a[e],n=i.getAttribute("data-module-init").split(" "),s=0;s<n.length;s++){try{t=require("modules/"+n[s])}catch(a){t=!1,console.log(n[s]+" module does not exist.")}t&&new t(i)}}var settings=require("modules/settings"),barba=require("barba.js");module.exports=function(a){function e(){index.init()}function t(){Barba.Pjax.start(),Barba.Dispatcher.on("newPageReady",function(a,e,t){$("body").removeClass().addClass($(t).find("main").data("page")),settings.prevPage=settings.page;var i=$(t).find("main").data("page").split("page-").join("");settings.page=i,$("body").attr("data-page",i),"home"==settings.prevPage&&$("body").addClass("animating-home")}),Barba.Dispatcher.on("transitionCompleted",function(){initializeBarbaModules(),$("body").hasClass("page-project")&&$(".waiting").show(),$("body").hasClass("page-project")||setTimeout(function(){$(".waiting").hide()},1e3),"about"==settings.page&&(settings.animating=!1)})}function i(){$("*").addClass("no-trans"),clearTimeout(n),n=setTimeout(function(){$("*").removeClass("no-trans")},300),1.5*s.height()<s.width()?$("body").addClass("landscape-format"):$("body").removeClass("landscape-format")}var n,s=($(a),$(window));$(".cursor");!function(){"mobile"==$("body").data("device")&&(settings.isMobile=!0),settings.isMobile||t(),e(),s.on("resize",i),$("body").hasClass("page-project")||setTimeout(function(){settings.init=!1},200)}(),i()};
},{"barba.js":1,"modules/settings":"modules/settings"}],"modules/settings":[function(require,module,exports){
var settings=module.exports={page:$("body").data("page").split("page-").join(),prevPage:"",currentProject:0,animating:!1,init:!0,currImage:Number($(".curr-num").text()-1),totalImages:0,isMobile:!1};settings.page=settings.page,settings.currentProject=settings.currentProject,settings.animating=settings.animating,settings.init=settings.init,settings.currImage=settings.currImage;
